        """
        Batch Processor V03moq
        ======================
        Lightweight ETL component that can normalise millions of rows efficiently.
...
from pathlib import Path
        ...
        APP_NAME    = "Batch Processor V03moq"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight ETL component that can normalise millions of rows efficiently.")
